...
export interface IEdbSessionInfo {
  user: IEdbUser
  createdAt: Date
  expiresAt: Date
}

export const DEFAULT_EDB_SESSION: IEdbSessionInfo = {
...
export const API_GENES_GENOMES_URL = `${API_GENES_URL}/genomes`
export const API_GENES_OVERLAP_URL = `${API_GENES_URL}/overlap`
export const API_GENES_INFO_URL = `${API_GENES_URL}/info`
...
export async function fetchAccessTokenUsingSession(
  ...
  try {
    ...
    const res = await queryClient.fetchQuery({
      ...
      queryFn: () =>
        httpFetch.postJson(SESSION_ACCESS_TOKEN_URL, {
    ...
    console.log('cannot fetch access token from remote')
  }
