...
export const ICON_TRANSITION_FROM_CLS =
  'group-hover:opacity-0 group-focus-visible:opacity-0 transition-all duration-400 ease-out group-hover:scale-70 group-focus-visible:scale-70'
...
export const ICON_TRANSITION_TO_CLS = `absolute opacity-0 scale-70 
  ...
  duration-400 ease-out group-hover:scale-100 group-focus-visible:scale-100
