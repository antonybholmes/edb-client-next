...
// import { NO_CELL, type ICell } from '@/interfaces/cell'
...
// import type { Shape } from '@/lib/dataframe'
...
//   const [editCell, setEditCell] = useState<ICell>(NO_CELL)
...
//   const { update:updateSelection } = useSelectionRange()
...
//   const [focusCell, setFocusCell] = useState<ICell>(NO_CELL)
