...
export const BoxPlotSvg = forwardRef<SVGElement, IProps>(function BoxPlotSvg(
  { plotAddr }: IProps,
  svgRef
) {
  ...
  const svg = useMemo(() => {
    ...
    const globalYAxis = new YAxis()
      ...
      .setLength(displayOptions.plot.height)
    ...
    const innerWidth =
      ...
      ((!split && hueOrder!.length < 3 ? hueOrder!.length : 1) *
        (displayOptions.plot.width + displayOptions.padding.hue) +
    ...
    const height = displayOptions.plot.height + margin.top + margin.bottom
    ...
    return (
      <svg
        ...
        // @ts-expect-error
        ref={svgRef}
        width={width * displayOptions.page.scale}
        height={height * displayOptions.page.scale}
      ...
      >
        ...
        >
                    ...
                    >
                      {displayOptions.violin.show && (
                        <ViolinPlotSvg
                          ...
                          yax={yax}
                          width={displayOptions.plot.width}
                          height={displayOptions.plot.height}
                          stroke={violinStroke}
                          fill={violinFill}
                          mode={
          ...
          <g transform={`translate(-${displayOptions.padding.hue}, 0)`}>
            ...
            <g transform={`translate(0, ${displayOptions.plot.height})`}>
