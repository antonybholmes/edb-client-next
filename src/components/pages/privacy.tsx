      ...
      <ContentDiv className="mt-8 text-sm">
        ...
        <BaseCol className="gap-y-4">
          ...
          <p>
            ...
            discarded once it has been processed and any results have been sent
            back to you. In the case of an Excel file, if you convert the Excel
            file to a tab delimited text file yourself and then load this into
            Experiments, the data will remain local.
          </p>
          <p>
