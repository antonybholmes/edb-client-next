...
import type { IVariant } from './variants'

export const COLOR_PALETTE: readonly string[] = Object.freeze([
  '#000080',
  '#4682B4',
  '#87CEEB',
  '#FFE4B5',
...
export const DEFAULT_VARIANT_LEGEND_ORDER = deepFreeze([
  'Missense',
  'Splice',
  'Frameshift',
  'Nonsense',
  'Inframe indel',
]) as readonly VariantClass[] // Reverse to have the most common mutation type first
...
export const DEFAULT_COLOR_MAP: Readonly<Record<VariantClass, string>> =
  deepFreeze(
    Object.fromEntries([
      ['Inframe indel', '#996633'],
      ['Nonsense', '#000000'],
      ['Splice', '#9966CC'],
      ['Frameshift', '#ff0000'],
      ['Missense', '#3cb371'],
    ] as [VariantClass, string][])
...
// export const DEFAULT_PROTEIN: IProtein = deepFreeze({
//   geneSymbol: '',
//   name: '',
//   accession: '',
//   sequence: '', // AminoAcid[]
...
export const DEFAULT_LOLLIPOP: ILollipop = deepFreeze({
  //protein: null,
  datasets: [],
  datasetsForUse: {},
  aaStats: [],
...
export interface IDomain extends IDBEntity, IDomainColors {
  start: number
  end: number
  show: boolean
...
export const DEFAULT_DOMAIN: IDomain = Object.freeze({
...
export interface IProteinLabel extends IDBEntity {
  start: number
  color: string
  show: boolean
}
...
export function parseVariantClassification(variant: string): VariantClass {
